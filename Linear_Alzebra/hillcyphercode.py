...
def encrypt(msg):
    ...
    C = make_key()
    # Append zero if the messsage isn't divisble by 2, later it will be removed
...
def make_key():
    ...
    C = None
    while True:
        cipher = "hill"   # Change this string to change the encryption key
